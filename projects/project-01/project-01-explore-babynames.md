...
tbl_names_popular |> 
  ...
  labs(
    title = 'Most Popular US Baby Names (2011-2020)',
    subtitle = 'Noah & Emma are most popular names',
    caption = 'Source:-SSA',
    x = 'Number of Births',
    y = 'Name'
  ) +
...
tbl_names_by_letter |> 
  ...
  labs(
    title='Distribution of Births by First Letter',
...
``` r
plot_trends_in_letter("A")
```

<img src="img/question-3-visualize-2-2.png" width="100%" style="display: block; margin: auto;" />
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
    title = "Distribution of First & Last letters in Names",
...
```
    ...
    #>  3 F      1880 vowel             consonant            5708     0.0627 vowel,con…
    #>  4 F      1880 vowel             vowel               18533     0.204  vowel,vow…
    #>  5 F      1881 consonant         consonant           20069     0.218  consonant…
    #>  6 F      1881 consonant         vowel               47287     0.514  consonant…
    #>  7 F      1881 vowel             consonant            5669     0.0617 vowel,con…
    #>  8 F      1881 vowel             vowel               18928     0.206  vowel,vow…
...
tbl_names_vowel_consonant |> 
  ...
  # Add labels (title, subtitle, caption, x, y)
  labs(
    title="Distribution of Vowels and Consonents",
    subtitle="For First & Last letter of names",
    caption="Source:-SSA",
    x="Year",
    y="Percentage of Births"
  )+
